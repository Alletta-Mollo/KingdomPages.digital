      ...
      <section className="container mx-auto">
        <div className="grid md:grid-cols-2 gap-10 items-start">
          ...
          >
            ...
            <ContactInfoCard icon={Phone} title="Call Us" content="xxx xxx xxxx" href="tel:+15551234567" delay={0.2} />
            <ContactInfoCard icon={MapPin} title="Our Office" content="xxx xxx xxxx" delay={0.3} />
          </motion.div>
