        ...
        >
          ...
          <div className="space-y-6 text-lg text-foreground/90 leading-relaxed">
            ...
            <div className="p-6 bg-muted/50 rounded-lg">
              ...
              <p className="mt-4">
                Congratulations! You are now a child of God. We want to send you ministry resources to help you grow as a Christian. We would like to have your contact details so we can send you a book titled <em>'Now that you are born-again.'</em>
              </p>
            </div>
